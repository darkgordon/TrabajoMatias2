...
public class MenuCatalogo2 extends AppCompatActivity {
    EditText editText;
    EditText editText2;
    String f1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.menu_catalogo_2);
    ...
    public void catalogo2(View view){
        Intent catalogo2= new Intent(this,RecyclerViewCatalago2.class);
        startActivity(catalogo2);
    ...
    public void agregar (View view) {
        ...
        try{
            pruebaConsultas.add2(nombreProducto,PrecioProducto,f1);
